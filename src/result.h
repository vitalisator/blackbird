...
struct Result {
  ...
  double minSpread[11][11];
  double maxSpread[11][11];
  double avgSpread[11][11];
  double trailing[11][11];
  unsigned trailingWaitCount[11][11];
  std::list<double> volatility[11][11];
